...
const VTable = struct {
    appendMessage: *const fn (*anyopaque, []const u8) void,
    getCards: *const fn (*anyopaque) []Card,
    discard: *const fn (*anyopaque, *Card) void,
    isBlockedByModal: *const fn (*anyopaque) bool,
    setLost: *const fn (*anyopaque) void,
    setWon: *const fn (*anyopaque) void,
    setHelping: *const fn (*anyopaque) void,
    startNewGame: *const fn (*anyopaque) void,
    grabWeapon: *const fn (*anyopaque, *Card) void,
    fight: *const fn (*anyopaque, *Card) bool,
    heal: *const fn (*anyopaque, i6) void,
    drawFromDungeon: *const fn (*anyopaque) ?*Card,
    putAtBottomOfDungeon: *const fn (*anyopaque, *Card) void,
};
